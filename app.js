...
app.get('/getData', function(request, response) {
    ...
    var req = http.get('https://robereng.iriscouch.com/radar/_all_docs?include_docs=true', function(res) {
...
app.get("/edit", function(request, response) {
    ...
    var req = http.get('https://robereng.iriscouch.com/radar/' + request.query.id, function(res) {
        res.setEncoding('utf8');
        var data = '';
        res.on('data', function(chunk) {
            data += chunk;
        ...
        res.on('end', function() {
            dataNodes = JSON.parse(data);
            response.locals.tech = {
                id: dataNodes._id,
                rev: dataNodes._rev,
                date_added: dataNodes.date_added,
                name: dataNodes.name,
                description: dataNodes.description,
                stage: dataNodes.stage,
                type: dataNodes.type
            };
